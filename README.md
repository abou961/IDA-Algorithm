# AI Project
Implementation of the IDA* algorithm for solving a problem of optimizing the moves to be played on a succession of blocks numbered to stack them in increasing order. 
